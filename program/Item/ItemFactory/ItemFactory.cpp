...
void ItemFactory::OnCreate()
{
    ...
    // お金
    m_itemDataTable.emplace(static_cast<int>(ItemType::Gold), ItemData{ "ゴールド", ItemType::Gold, static_cast<int>(ItemIdType::Gold), 1, 0,true });
    // ポーション系
    ...
    m_itemDataTable.emplace(static_cast<int>(ItemIdType::IntermediatePotion), ItemData{ "中級ポーション", ItemType::Potion, static_cast<int>(ItemIdType::IntermediatePotion), 100, 100, true });
